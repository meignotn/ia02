...
/*choix des IA ou non: après l'affichage du "write" de InitBoard(_), on lit la valeur entrée: au début du jeu, si A vaut 1 alors B vaut 1 suite au prédicat choixAuxJ1 (et si A vaut 0 alors B vaut 0).  */
